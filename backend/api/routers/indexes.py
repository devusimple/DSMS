...
from api.routers.deps import ConnectionRecord, get_connection
from api.schemas import IndexCreate
from api.sqlgen import create_index_sql, drop_index_sql
...
@router.delete(
    "/connections/{conn_id}/tables/{table_name}/indexes/{index_name}", status_code=204
)
def drop_index(
    conn_id: str,
    table_name: str,
